...
def display_insights(df, matching_docs, section_title="Research Insights", 
    ...
    with insights_container:
        ...
        if insights_key in st.session_state:
            ...
            insights_html = f'<div style="height: {height}px; overflow-y: auto; padding: 0.5rem; border: 2px solid #c4ddf2; border-radius: 0.5rem;">'
            ...
            try:
                ...
                html = f"""
                <div style="height: {height}px; overflow-y: auto; padding: 0.5rem; border: 2px solid #c4ddf2; border-radius: 0.5rem; display: flex; flex-direction: column; align-items: center; justify-content: center;">
